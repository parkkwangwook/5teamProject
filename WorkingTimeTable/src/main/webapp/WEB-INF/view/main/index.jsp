...
<head>
		...
		<link rel="stylesheet" href="<%=request.getContextPath()%>/css/zerogrid.css" type="text/css" media="all">
		<link rel="stylesheet" href="<%=request.getContextPath()%>/css/responsive.css" type="text/css" media="all">
...
<body id="page1">
	...
	<div class="slider-wrapper">
		<div class="slider">
			<ul class="items">
				<li><img src="images/slider-bg1.png" alt=""> <div class="banner">
		...
		<div class="main zerogrid">
			<div class="row">
				<article class="col-1-3">
					<a href="mypage.jsp"><img src="images/attendance.png" alt="출석체크"></a>
				</article>
				<article class="col-1-3">
					<a href="timetable.jsp"><img src="images/timetable.png" alt="근무표조회"></a>
				</article>
				<article class="col-1-3">
			...
			<div class="row">
				<article class="col-1-2">
					<div class="wrap-col">
						...
						<span class="button-2"> <a href="board.jsp"><strong>Go Freeboard</strong></a>
						</span>
					</div>
				</article>
				<article class="col-1-2">
					<div class="wrap-col">
						...
						<span class="button-2"><a href="http://www.kma.go.kr" target="_blank"><strong>Connect to KMA</strong></a>
						</span>
					</div>
				</article>
